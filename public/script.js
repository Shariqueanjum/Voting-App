...
<div class="progress">
    ...
    `);
        ...
        //
        $("#btnLivePoll").show();
        // var urlLink = "poll-maker-2020.herokuapp.com";
        // if(PORT===5432)urlLink = "localhost:5432";
        $("#btnLivePoll").css(
          "title",
          "http://localhost:5432/?yourpoll=" + pollId
        );
        ...
        copyToClipboard("http://localhost:5432/?yourpoll=" + pollId);
        $("#btnLivePoll").click(() => {
          $.get("/data", {}, (data_poll) => {
